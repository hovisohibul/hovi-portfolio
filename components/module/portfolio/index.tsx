        ...
        >
            <div className='flex flex-col gap-4 max-w-[700px] z-10'>
                ...
                <p className='text-neutral-300 text-[16px] leading-relaxed texting'>
                    Over the past few years, I have been building and experimenting with modern web interfaces as a frontend developer. 
                    Each project represents my approach to crafting clean, responsive, and user-friendly web experiences.
                </p>

                <p className='text-neutral-400 text-[15px] leading-relaxed texting'>
                    From interactive UI components to optimized layouts, I focus on creating websites 
                    that are not only visually appealing but also performant and scalable across different devices and screen sizes.
                </p>
            </div>
